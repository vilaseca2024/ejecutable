...
def eval_expr(expr, row_dict):
    # Evalúa expresiones aritméticas que pueden contener referencias a campos
...
def extraer_campos_pdf(ruta_pdf):
    ...
    try:
        ...
        pass
    # Se guarda un archivo de validación (opcional)
...
def process_all():
    ...
    for ruta in rutas_pdfs:
        ...
        for row_dict in rows_data:
            ...
            current_row += 1
        # Agregar una fila en blanco entre cada bloque (PDF)
        current_row += 1
...
def handle_btn_press(option):
    if option == "about":
        ...
        instrucciones = (
            ...
            "4. Espero que el programa te sea útil; ¡éxito! Y cualquier mejora, anótala y házmela saber."
        )
